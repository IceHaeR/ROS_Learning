...
if __name__ == '__main__':
    rospy.init_node(vehicle_type+'_get_master_pose_groundtruth')
    gazebo_model_state_sub = rospy.Subscriber("/master/gazebo/model_states", ModelStates, gazebo_model_state_callback,queue_size=1)
